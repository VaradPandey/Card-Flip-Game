...
const highscore=()=>{
    ...
    if(currentHigh===0.00||high<currentHigh){
        ...
        localStorage.setItem('highlocal', JSON.stringify(high));
    }
}
const loadHighScore=()=>{
    let storedHigh=JSON.parse(localStorage.getItem('highlocal'))||0;
    document.querySelector('.highestnumber').innerHTML=storedHigh.toFixed(2);
}
